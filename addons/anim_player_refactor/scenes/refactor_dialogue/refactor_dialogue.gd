...
func _on_tree_button_clicked(item: TreeItem, column: int, id: int, mouse_button_index: int):
	...
	if id == 0:
		...
		_on_RefactorAction(RefactorAction.Delete)


func _on_RefactorAction(refactor_action: RefactorAction):
	if refactor_action == RefactorAction.Rename:
	...
	elif refactor_action == RefactorAction.Delete:
